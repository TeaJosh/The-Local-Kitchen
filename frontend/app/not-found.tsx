    ...
    <main className="flex items-center justify-center min-h-screen px-6">
      <div className="py-8 px-4 mx-auto max-w-screen-xl transform -translate-y-32 lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center gap-2 flex flex-col items-center">
          ...
          <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, the page you are looking for does not exist.</p>
          <Link href="/" className="px-10 py-4 text-lg bg-blue-500 text-white rounded-md hover:bg-blue-600">Back to Homepage</Link>
        </div>
        </div>
      </main>
  );
