  ...
  return (
    <div className="flex justify-center">
      <div className="max-w-3xl px-6 py-16">
        ...
        {/* Intro Paragraphs */}
        <p style={bodyMargin}>
          Welcome to The Local Kitchen. By accessing or using our website, you
          agree to the following Terms of Service ("Terms").
        </p>
        <p style={bodyMargin}>
        ...
        <section>
          ...
          <div style={sectionMargin}>
            <Section title="1. Description of Service">
              <p style={bodyMargin}>
                The Neighborhood Kitchen is a platform that allows users to:
              </p>
              <ul
                style={listMargin}
