...
export default function Home() {
  return (
    <div className="bg-white dark:bg-black font-sans min-h-screen">
      ...
      {/* Hero Banner */}
      <div className="w-full relative h-screen w-screen overflow-hidden">
        <video
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-start text-center px-4 pt-24 translate-y-42">
          <h1 className="text-5xl md:text-7xl lg:text-7xl font-extrabold text-white max-w-2xl">
        ...
        <div className="max-w-screen-xl max-lg:max-w-3xl mx-auto">
          <div className="grid lg:grid-cols-2 items-center gap-x-12 gap-y-16">
            <div className="max-lg:text-center">
              <h1 className="md:text-5xl text-4xl !leading-tight font-bold mb-6">Our Story</h1>
              <p className="text-2xl text-slate-800 leading-relaxed" style={{ marginTop: "24px" }}>
      ...
      <div className="py-8 px-6 flex flex-col items-center">
        <div className="max-w-7xl w-full mb-8">
          <h2 className="text-4xl font-bold text-center mt-32" style={{ marginTop: "128px", marginBottom: "0", marginLeft: "24px", marginRight: "24px" }}>
            How it Works
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-screen-2xl w-full mt-6" style={{ marginTop: "24px" }}>
          ...
          <Link href="/blog/">
            <div className="bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden flex flex-col h-full">
              ...
              <div className="p-6">
                ...
                <p className="mt-4 text-lg text-slate-800 leading-relaxed" style={{ marginTop: "12px" }}>
      ...
      <section className="flex h-[500px] mt-24" style={{ marginTop: "64px" }}>
        <div className="bg-sky-500 w-1/2 flex flex-col justify-center items-center text-center px-16">
          ...
          <p className="text-white text-xl mb-6" style={{ margin: "18px", marginTop: "24px" }}>
          ...
          <Link href="/about">
            <div className="border p-8 text-xl text-white font-semibold hover:bg-white hover:text-sky-500" style={{ marginTop: "12px", padding: "16px" }}>
      ...
      <div className="bg-sky-800 px-8 py-16" style={{ minHeight: "350px" }}>
        <div className="flex flex-col md:flex-row items-center justify-center gap-12">
          <div className="text-center md:text-left max-w-md" style={{ marginTop: "48px" }}>
            ...
            <p className="text-lg lg:text-xl text-white" style={{ marginTop: "24px", marginBottom: "24px" }}>
              We're here with the answer. Fill out the contact form on the next page and we'll get back to you quickly.
            </p>
            <a href="/contact" className="mt-8 inline-block border p-8 text-xl text-white font-semibold hover:bg-white hover:text-sky-800" style={{ padding: "12px" }}>
              Contact
            </a>
          </div>
          <Image
