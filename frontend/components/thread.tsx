  ...
  return (
    ...
    >
      <ThreadPrimitive.Viewport
        ...
        className="relative flex flex-1 flex-col overflow-x-auto overflow-y-scroll scroll-smooth min-h-0"
      >
    ...
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      <ComposerPrimitive.AttachmentDropzone asChild>
        <div
          ...
          className="flex w-full min-w-0 flex-col gap-2 rounded-(--composer-radius) border bg-background p-(--composer-padding) rounded-md"
        >
          <ComposerAttachments />
          <ComposerPrimitive.Input
            placeholder="Send a message..."
            className="aui-composer-input max-h-32 min-h-10 w-full resize-none bg-transparent px-1.75 py-1 text-sm outline-none placeholder:text-muted-foreground/80 break-words break-all whitespace-pre-wrap overflow-hidden"
            rows={1}
            autoFocus
